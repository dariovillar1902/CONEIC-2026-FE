            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-6">
                        ...
                        <Link
                            to="/login"
                            className="font-subtitle text-xs font-bold uppercase tracking-widest bg-primary-red text-white px-4 py-2 rounded-full hover:bg-red-800 transition-colors shadow-sm"
                        >
                            Ingresar
                        </Link>
                    </div>
