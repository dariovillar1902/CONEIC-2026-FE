...
const STATIC_DAYS = [
  {
    ...
    slots: [
      ...
      { time: '16:45–19:05', name: 'Charlas Magistrales 1–6',               type: 'academic',  detail: 'Auditorio Belgrano' },
      { time: '23:00',       name: 'Fiesta de Bienvenida 🚧',               type: 'social',    detail: 'Obra en Construcción' },
    ],
  },
  {
    ...
    headerColor: 'bg-estructuras text-white', borderColor: 'border-estructuras',
    slots: [
      { time: '08:30–12:00', name: 'Talleres y Simultáneas',                type: 'workshop',   detail: 'UTN FRBA – Medrano y Campus' },
      { time: '10:00–10:30', name: 'Coffee Break',                          type: 'break' },
      { time: '12:30–14:00', name: 'Almuerzo libre',                        type: 'break' },
      { time: '14:00–18:00', name: 'Solidarias – Charlas de Compromiso Social', type: 'solidarity', detail: 'UTN FRBA' },
      { time: '17:00–17:40', name: 'Coffee Break',                          type: 'break' },
      { time: '23:00',       name: 'Fiesta',                                type: 'social' },
    ],
  },
  {
    ...
    headerColor: 'bg-sostenibilidad text-white', borderColor: 'border-sostenibilidad',
    slots: [
      { time: '08:00',       name: 'Visitas Técnicas',                      type: 'visit',     detail: 'Punto de encuentro – Campus UTN FRBA' },
      { time: '13:00–14:00', name: 'Tiempo libre',                          type: 'break' },
      { time: '16:00–16:30', name: 'Reunión de Asamblea ANEIC',             type: 'aneic',     detail: 'Auditorio Campus UTN FRBA' },
      { time: '17:25–17:45', name: 'Coffee Break Salado',                   type: 'break' },
      { time: '17:50–18:30', name: 'Actividad Recreativa',                  type: 'social',    detail: 'Carpa Campus UTN FRBA' },
    ],
  },
  {
    ...
    headerColor: 'bg-complementary-gold text-white', borderColor: 'border-complementary-gold',
    slots: [
      { time: '09:00–12:00', name: 'Charlas Magistrales 7–12',              type: 'academic',  detail: 'Auditorio Belgrano' },
      { time: '10:00–10:30', name: 'Coffee Break',                          type: 'break' },
      { time: '12:00–14:00', name: 'Almuerzo libre',                        type: 'break' },
      { time: '14:00–15:30', name: 'Charlas Magistrales 13–16',             type: 'academic',  detail: 'Auditorio Belgrano' },
      { time: '15:30–16:00', name: 'Descanso',                              type: 'break' },
      { time: '16:00–17:40', name: 'Charlas Magistrales 17–19',             type: 'academic',  detail: 'Auditorio Belgrano' },
      { time: '17:50–18:30', name: 'Acto de Cierre',                        type: 'general',   detail: 'Cierre oficial del XVIII CONEIC' },
      { time: '23:00',       name: 'Fiesta de Cierre – Gala',               type: 'social' },
    ],
  },
];
