...
import { CommitteeSectionContent } from './CommitteePage';
import { SubcommitteesSectionContent } from './SubcommitteesPage';

// ─── Tabs definition ───────────────────────────────────────────────────────────
const TABS = [
    { id: 'congreso',      label: 'El Congreso' },
    { id: 'comite',        label: 'Comité Organizador' },
    { id: 'subcomisiones', label: 'Subcomisiones ANEIC' },
];
            ...
            <div className="flex gap-1 py-2 overflow-x-auto scrollbar-none">
                {TABS.map(tab => (
                    <button
                        ...
                        className={`flex-shrink-0 px-6 py-2 rounded-full font-bold text-xs uppercase tracking-widest transition-all font-subtitle ${
                            active === tab.id
                                ? 'bg-institutional text-white shadow-sm'
                                : 'text-gray-500 hover:text-institutional border border-gray-200 hover:border-institutional/60 bg-white'
                        }`}
                    >
                        {tab.label}
                    </button>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
                ...
                <div className="flex gap-8 pt-4">
                    <div><h4 className="text-3xl font-bold text-primary-blue">18+</h4><p className="text-gray-500 text-sm uppercase">Ediciones</p></div>
                    <div><h4 className="text-3xl font-bold text-primary-blue">25+</h4><p className="text-gray-500 text-sm uppercase">Universidades</p></div>
                    <div><h4 className="text-3xl font-bold text-primary-blue">1200+</h4><p className="text-gray-500 text-sm uppercase">Asistentes</p></div>
                </div>
            </div>
        ...
        <div>
            ...
            <div className="flex flex-wrap justify-center gap-8">
                <ActivityCard icon="🎤" title="Charlas Magistrales" description="Disertaciones de expertos nacionales e internacionales que comparten su visión sobre los grandes desafíos y obras de la ingeniería moderna." />
                <ActivityCard icon="🏗️" title="Visitas Técnicas" description="Recorridos exclusivos a las obras de infraestructura más emblemáticas de Buenos Aires: Subtes, Rascacielos, Obras Hidráulicas y el Puerto." />
                <ActivityCard icon="🛠️" title="Talleres Prácticos" description="Espacios de formación 'Hands-On' donde los estudiantes aplican software de cálculo, nuevos materiales y metodologías ágiles." />
                <ActivityCard icon="🤝" title="Actividad Solidaria" description="Devolvemos a la sociedad parte de lo que recibimos, realizando intervenciones constructivas en comunidades vulnerables de la región." />
                <ActivityCard icon="🎉" title="Eventos Sociales" description="Fomentamos el networking y la integración federal a través de cenas, peñas y actividades recreativas cada noche." />
            </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2 space-y-6">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 bg-institutional text-white px-6 py-3 rounded-full font-bold hover:bg-primary-red transition-colors shadow-md text-sm uppercase tracking-widest"
                    >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                    <a href="https://www.instagram.com/aneicargentina" target="_blank" rel="noopener noreferrer"
                    ...
                    <button onClick={() => setTab('subcomisiones')}
...
const AboutPage = () => {
    ...
    const activeTab = searchParams.get('tab') || 'congreso';

    const setTab = (tab) => {
        if (tab === 'congreso') setSearchParams({});
        ...
        <div className="w-full font-body pt-20">
            ...
            <div className="relative bg-institutional text-white py-20 px-4 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <h1 className="text-5xl md:text-6xl font-bold font-title mb-4 animate-fade-in-down">Sobre Nosotros</h1>
                    <p className="max-w-3xl mx-auto text-xl text-gray-200 leading-relaxed font-subtitle">
                        XVIII CONEIC · Buenos Aires · 13 al 16 de octubre&nbsp;2026
                    </p>
                </div>
            </div>
            ...
            {/* Tab content */}
            {activeTab === 'congreso'      && <CongresoTab setTab={setTab} />}
            {activeTab === 'comite'        && <CommitteeSectionContent />}
            {activeTab === 'subcomisiones' && <SubcommitteesSectionContent />}
