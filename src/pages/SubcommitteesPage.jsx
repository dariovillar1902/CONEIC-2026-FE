const SubcommitteesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-body flex flex-col pt-24">
      <main className="flex-grow pb-12 px-4 md:px-8 max-w-7xl mx-auto w-full">
        {/* ANEIC Section */}
        <div className="text-center mb-16 space-y-4">
          <span className="text-complementary-gold font-bold tracking-widest uppercase text-sm">Espacio ANEIC</span>
          <h1 className="text-4xl md:text-5xl font-bold text-institutional font-title">
            Subcomisiones de ANEIC&nbsp;Argentina
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Conocé las subcomisiones de trabajo de la Asociación Nacional de Estudiantes de Ingeniería Civil.
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {subcommittees.map((sub) => (
            <div key={sub.id} className="bg-accent rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1 group border border-gray-200">
              <div className="p-6">
