...
const SubCard = ({ sub }) => (
  <div className="bg-accent rounded-2xl shadow-sm overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1 group border border-gray-200">
    <div className="p-6">
      ...
      <a href={sub.whatsapp} target="_blank" rel="noopener noreferrer"
...
export const SubcommitteesSectionContent = () => (
  <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      {SUBCOMMITTEES.map(sub => <SubCard key={sub.id} sub={sub} />)}
    </div>
    <div className="mt-12 bg-institutional rounded-3xl p-10 text-center text-white">
      ...
      <p className="text-gray-300 max-w-xl mx-auto mb-6 font-subtitle">
        Sumate a una subcomisión y formá parte activa de la asociación estudiantil de ingeniería civil más grande del&nbsp;país.
      </p>
      <a href="mailto:coneic.argentina@gmail.com" className="inline-block bg-primary-red text-white font-bold px-8 py-3 rounded-full hover:bg-red-900 transition-colors shadow-md uppercase tracking-widest text-sm">
        Contactar a ANEIC
      </a>
    </div>
  </div>
    ...
    <div className="min-h-screen bg-complementary-light font-body pt-24">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="mt-16 bg-institutional rounded-3xl p-10 text-center text-white">
          ...
          <Link to="/about" className="inline-block bg-primary-red text-white font-bold px-8 py-3 rounded-full hover:bg-red-900 transition-colors shadow-md uppercase tracking-widest text-sm">
